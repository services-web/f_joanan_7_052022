<template>
  <nav
    ...
    class=" shadow-lg w-full flex items-center justify-center md:justify-between flex-wrap bg-gray-600 h-24s md:h-16 mt-0 pl-8 pr-8 top-0 z-10
  ...
  >
    ...
    <div class="flex w-full justify-around md:w-max flex-end">
      ...
      <template v-if="status == 'isConnected'">
        <router-link to="/wall" class="text-gray font-semibold hover:text-green-600 mx-3"
          >Mur</router-link
        >
      ...
      <template v-else>
        <router-link to="/login" class="text-white font-semibold hover:text-green-500 mx-3"
          >Connexion</router-link
        >
        <router-link to="/signup" class="text-white font-semibold hover:text-green-500 mx-3"
