    ...
    <div class="w-11/12 md:w-5/6 lg:w-3/6  bg-white py-5 rounded-xl shadow-lg">
      ...
      >
        <img
          ...
          class="inline object-cover rounded-full h-24 w-24 border-8 border-green-200 shadow-md mr-4"
          :src="user.picture"
          alt="photo de profil"
        />
        <button
...
export default {
  ...
  data: () => ({
    showModal: false, // La modale ne doit pas s'afficher initialement
  }),
